...
<body>
    ...
    <p style="position: relative; top: -1415px">Source: <a href="https://covidtracking.com/api/v1/states/current.json">https://covidtracking.com/api/v1/states/current.json</a></p>
</body>
