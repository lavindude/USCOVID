...
<body>
    ...
    <p style="font-family: monospace;">Click <a href="css/style.css">here</a> if you want to know how the</p>
    ...
    <div class="mapdiv">
        ...
        <a xlink:title="Massachusetts" xlink:href="">
        <path
        ...
        <a xlink:title="Minnesota" xlink:href="">
        <path
            inkscape:connector-curvature="0"
            id="MN"
            <?php 
        ...
        <a xlink:title="Montana" xlink:href="">
        <path
            inkscape:connector-curvature="0"
            id="MT"
            <?php 
        ...
        <a xlink:title="North Dakota" xlink:href="">
        <path
            inkscape:connector-curvature="0"
            id="ND"
            <?php 
        ...
        <a xlink:title="Hawaii" xlink:href="">
        <path
            inkscape:connector-curvature="0"
            id="HI"
            <?php 
        ...
        <a xlink:title="Idaho" xlink:href="">
        <path
            inkscape:connector-curvature="0"
            id="ID"
            <?php 
        ...
        <a xlink:title="Washington" xlink:href="states/washington.php">
        <path
            inkscape:connector-curvature="0"
            id="WA"
            <?php 
        ...
        <a xlink:title="Arizona" xlink:href="">
        <path
            inkscape:connector-curvature="0"
            id="AZ"
            <?php 
