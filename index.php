...
<body>
    <p>***</p> 
    <p style="position: relative; left: 5px; font-size: 20px;">Click each state to see COVID statistics about them.</p> 
    <p style="position: relative; left: 5px; font-size: 20px;">Hover over each state to see the name of the state.</p>
    <p>***</p> <br>
    <p>KEY:</p>
    ...
    <div class="mapdiv">
        ...
        style="position: relative; left: 140px; top: -400px"
        >
        <defs>
        ...
        <path
            ...
            id="MA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=19");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
                    else if ($row['color'] == 'r') {
                        echo('style = "fill: #ff000f;"'); 
                    }
        ...
        <a xlink:title="Minnesota" xlink:href="state_data.php?state_id=23">
        <path
            inkscape:connector-curvature="0"
            id="MN"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=23");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Montana" xlink:href="state_data.php?state_id=26">
        <path
            inkscape:connector-curvature="0"
            id="MT"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=26");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="North Dakota" xlink:href="state_data.php?state_id=28">
        <path
            inkscape:connector-curvature="0"
            id="ND"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=28");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Hawaii" xlink:href="state_data.php?state_id=11">
        <path
            inkscape:connector-curvature="0"
            id="HI"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=11");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Idaho" xlink:href="state_data.php?state_id=13">
        <path
            inkscape:connector-curvature="0"
            id="ID"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=13");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Washington" xlink:href="state_data.php?state_id=47">
        <path
            inkscape:connector-curvature="0"
            id="WA"
            <?php 
        ...
        <a xlink:title="Arizona" xlink:href="state_data.php?state_id=4">
        <path
            inkscape:connector-curvature="0"
            id="AZ"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=4");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="California" xlink:href="state_data.php?state_id=5">
        <path
            inkscape:connector-curvature="0"
            id="CA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=5");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Colorado" xlink:href="state_data.php?state_id=6">
        <path
            inkscape:connector-curvature="0"
            id="CO"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=6");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Nevada" xlink:href="state_data.php?state_id=34">
        <path
            inkscape:connector-curvature="0"
            id="NV"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=34");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="New Mexico" xlink:href="state_data.php?state_id=32">
        <path
            inkscape:connector-curvature="0"
            id="NM"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=32");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Oregon" xlink:href="state_data.php?state_id=37">
        <path
            inkscape:connector-curvature="0"
            id="OR"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=37");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Utah" xlink:href="state_data.php?state_id=44">
        <path
            inkscape:connector-curvature="0"
            id="UT"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=44");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Wyoming" xlink:href="state_data.php?state_id=50">
        <path
            inkscape:connector-curvature="0"
            id="WY"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=50");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <path
            ...
            id="AR"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=3");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Iowa" xlink:href="state_data.php?state_id=12">
        <path
            inkscape:connector-curvature="0"
            id="IA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=12");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Kansas" xlink:href="state_data.php?state_id=16">
        <path
            inkscape:connector-curvature="0"
            id="KS"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=16");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Montana" xlink:href="state_data.php?state_id=24">
        <path
            inkscape:connector-curvature="0"
            id="MO"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=24");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Nebraska" xlink:href="state_data.php?state_id=29">
        <path
            inkscape:connector-curvature="0"
            id="NE"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=29");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Oklahoma" xlink:href="state_data.php?state_id=36">
        <path
            inkscape:connector-curvature="0"
            id="OK"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=36");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="South Dakota" xlink:href="state_data.php?state_id=41">
        <path
            inkscape:connector-curvature="0"
            id="SD"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=41");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Louisiana" xlink:href="state_data.php?state_id=18">
        <path
            inkscape:connector-curvature="0"
            id="LA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=18");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Texas" xlink:href="state_data.php?state_id=43">
        <path
            inkscape:connector-curvature="0"
            id="TX"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=43");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Connecticut" xlink:href="state_data.php?state_id=7">
        <path
            inkscape:connector-curvature="0"
            id="CT"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=7");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="New Hampshire" xlink:href="state_data.php?state_id=30">
        <path
            inkscape:connector-curvature="0"
            id="NH"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=30");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Rhode Island" xlink:href="state_data.php?state_id=39">
        <path
            inkscape:connector-curvature="0"
            id="RI"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=39");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Vermont" xlink:href="state_data.php?state_id=46">
        <path
            inkscape:connector-curvature="0"
            id="VT"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=46");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <path
            ...
            id="AL"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=2");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Florida" xlink:href="state_data.php?state_id=9">
        <path
            inkscape:connector-curvature="0"
            id="FL"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=9");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Georgia" xlink:href="state_data.php?state_id=10">
        <path
            inkscape:connector-curvature="0"
            id="GA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=10");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Mississippi" xlink:href="state_data.php?state_id=25">
        <path
            inkscape:connector-curvature="0"
            id="MS"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=25");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="South Carolina" xlink:href="state_data.php?state_id=40">
        <path
            inkscape:connector-curvature="0"
            id="SC"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=40");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Illinois" xlink:href="state_data.php?state_id=14">
        <path
            inkscape:connector-curvature="0"
            id="IL"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=14");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Indiana" xlink:href="state_data.php?state_id=15">
        <path
            inkscape:connector-curvature="0"
            id="IN"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=15");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Kentucky" xlink:href="state_data.php?state_id=17">
        <path
            inkscape:connector-curvature="0"
            id="KY"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=17");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="North Carolina" xlink:href="state_data.php?state_id=27">
        <path
            inkscape:connector-curvature="0"
            id="NC"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=27");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Ohio" xlink:href="state_data.php?state_id=35">
        <path
            inkscape:connector-curvature="0"
            id="OH"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=35");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Tennessee" xlink:href="state_data.php?state_id=42">
        <path
            inkscape:connector-curvature="0"
            id="TN"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=42");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Virginia" xlink:href="state_data.php?state_id=45">
        <path
            inkscape:connector-curvature="0"
            id="VA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=45");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Wisconsin" xlink:href="state_data.php?state_id=48">
        <path
            inkscape:connector-curvature="0"
            id="WI"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=48");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="West Virginia" xlink:href="state_data.php?state_id=49">
        <path
            inkscape:connector-curvature="0"
            id="WV"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=49");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Delaware" xlink:href="state_data.php?state_id=8">
        <path
            inkscape:connector-curvature="0"
            id="DE"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=8");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <path
            ...
            />
            <a xlink:title="Maryland" xlink:href="state_data.php?state_id=20">
        <path
            inkscape:connector-curvature="0"
            id="MD"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=20");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="New Jersey" xlink:href="state_data.php?state_id=31">
        <path
            inkscape:connector-curvature="0"
            id="NJ"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=31");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="New York" xlink:href="state_data.php?state_id=33">
        <path
            inkscape:connector-curvature="0"
            id="NY"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=33");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Pennsylvania" xlink:href="state_data.php?state_id=38">
        <path
            inkscape:connector-curvature="0"
            id="PA"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=38");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Maine" xlink:href="state_data.php?state_id=21">
        <path
            inkscape:connector-curvature="0"
            id="ME"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=21");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Michigan" xlink:href="state_data.php?state_id=22">
        <path
            inkscape:connector-curvature="0"
            id="MI"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=22");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
        ...
        <a xlink:title="Alaska" xlink:href="state_data.php?state_id=1">
        <path
            inkscape:connector-curvature="0"
            id="AK"
            <?php 
                $data = $pdo->query("SELECT * FROM states WHERE state_id=1");
                while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
                    if ($row['color'] == 'y') {
                        echo('style = "fill: #eeff00;"'); 
                    }
    ...
    <p style="position: relative; top: -912px">Updated every day at 6:00 am PST ↓ </p>
    <p style="position: relative; top: -910px">Source: <a href="https://covidtracking.com/api/v1/states/current.json">https://covidtracking.com/api/v1/states/current.json</a></p>
</body>
